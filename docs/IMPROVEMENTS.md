...
| # | Punto |
|---|-------|
| 1 | [9.4 Refactor: helpers compartidos](#94-refactor-helpers-compartidos) |
| 2 | [9.12 Clase `Reserva`](#912-clase-reserva) |
| 3 | [9.7 Refactor post-extracción de módulos](#97-refactor-post-extracción-de-módulos) |
| 4 | [1.1 Auto-fetch en segundo plano](#11-auto-fetch-en-segundo-plano) |
| 5 | [3.1 Campo de entrada de fecha editable o de solo lectura](#31-campo-de-entrada-de-fecha-editable-o-de-solo-lectura) |
| 6 | [6.7 Notificaciones vía email (Gmail API)](#67-notificaciones-vía-email-gmail-api) |
| 7 | [9.8 Accesibilidad (WCAG 2.1 AA)](#98-accesibilidad-wcag-21-aa) |
...
|-----------|--------|
| 1 — Bugs críticos | |
| 2 — Infraestructura y calidad | [9.4](#94-refactor-helpers-compartidos), [9.6](#96-automatización-de-subida-a-chrome-web-store), [9.7](#97-refactor-post-extracción-de-módulos), [9.8](#98-accesibilidad-wcag-21-aa), [9.9](#99-testing-automatizado), [9.14](#914-análisis-estático-y-revisión-automática-de-código) |
